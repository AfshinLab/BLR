...
def add_arguments(parser):
    ...
    arg('--delete-all-output', default=False, action='store_true',
        help="Remove all files generated by the workflow. Use together with --dry-run to list files without actually "
             "deleting anything. Write-protected files are not removed. Nevertheless, use with care! Default: "
             "%(default)s")
